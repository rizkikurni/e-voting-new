                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="fs-5 ms-auto">
                                        <div class="d-flex align-items-center justify-content-sm-end gap-3 cursor-pointer">
                                            ...
                                            <div class="font-13"><i
                                                    class="bi bi-circle-fill text-purple opacity-75"></i><span
                                                    class="ms-2">Mob</span></div>
                                            <div class="font-13"><i
                                                    class="bi bi-circle-fill text-purple opacity-50"></i><span
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="fs-5 ms-auto">
                                    <div class="d-flex align-items-center justify-content-sm-end gap-3 cursor-pointer">
                                        ...
                                        <div class="font-13"><i class="bi bi-circle-fill text-pink opacity-50"></i><span
                                    ...
                                    <div class="d-sm-flex align-items-center gap-3 mt-3">
                                        ...
                                        <div class="align-self-end ms-auto">
                                            <div class="d-flex align-items-center gap-3">
                                                ...
                                                <p class="mb-0 font-13">
                                                    <i class="bi bi-square-fill ms-1 text-primary-3"></i> Returning
                                                    Visitors
                                                </p>
                                            </div>
                                        </div>
