                                ...
                                <div class="booking-form mt-50 wow fadeInLeft">
                                    ...
                                    <div class="text-center">
                                        <div class="candidate-image">
                                            <!-- Placeholder untuk foto kandidat -->
                                            <div style="width: 100%; height: 100%; background: #dee2e6;"></div>
                                        </div>

                                        <h4 class="candidate-name">Budi Santoso</h4>
                                        <p class="candidate-tagline">Perolehan suara: 500</p>

                                        <button class="btn btn-detail disabled">
                                            Detail Hasil
                                        </button>
                                    </div>
                                    {{-- end card --}}
